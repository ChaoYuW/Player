...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    self.ec_h = ScreenHeight;
    self.ec_w = MoreViewWidth;
...
- (void)sizeToFit
{
    ...
    _soundCell.ec_top(_contentHeight);
    _contentHeight += _soundCell.ec_h;
    
    _ligthCell.ec_top(_contentHeight);
    _contentHeight += _ligthCell.ec_h;

    
    if (!self.isLive) {
        _speedCell.ec_top(_contentHeight);
        _contentHeight += _speedCell.ec_h;
        
        _mirrorCell.ec_top(_contentHeight);
        _contentHeight += _mirrorCell.ec_h;
    ...
    _hwCell.ec_top(_contentHeight);
    _contentHeight += _hwCell.ec_h;
}
...
- (UIView *)soundCell
{
    if (_soundCell == nil) {
        ...
        _soundCell.ec_width(MoreViewWidth).ec_height(50).ec_left(10);
        ...
        sound.ec__centerY(_soundCell.ec_h/2);

        
        UIImageView *soundImage1 = [[UIImageView alloc] initWithImage:PlayerImage(@"sound_min")];
        [_soundCell addSubview:soundImage1];
        soundImage1.ec_left(sound.ec_maxX+10).ec__centerY(_soundCell.ec_h/2);

        UIImageView *soundImage2 = [[UIImageView alloc] initWithImage:PlayerImage(@"sound_max")];
        [_soundCell addSubview:soundImage2];
        soundImage2.ec_right(50).ec__centerY(_soundCell.ec_h/2);
        
        
        UISlider *soundSlider                       = [[UISlider alloc] init];
        [soundSlider setThumbImage:PlayerImage(@"slider_thumb") forState:UIControlStateNormal];
        ...
        soundSlider.ec__centerY(_soundCell.ec_centerY).ec_left(soundImage1.ec_maxX).ec_width(soundImage2.ec_minX-soundImage1.ec_maxX);
...
- (UIView *)lightCell
{
    if (_ligthCell == nil) {
        ...
        _ligthCell.ec_width(MoreViewWidth).ec_height(50).ec_left(10);
        ...
        ligth.ec__centerY(_ligthCell.ec_h/2);
        
        UIImageView *ligthImage1 = [[UIImageView alloc] initWithImage:PlayerImage(@"light_min")];
        [_ligthCell addSubview:ligthImage1];
        ligthImage1.ec_left(ligth.ec_maxX+10).ec__centerY(_ligthCell.ec_h/2);
        
        UIImageView *ligthImage2 = [[UIImageView alloc] initWithImage:PlayerImage(@"light_max")];
        [_ligthCell addSubview:ligthImage2];
        ligthImage2.ec_right(50).ec__centerY(_ligthCell.ec_h/2);
        
        
        UISlider *lightSlider                       = [[UISlider alloc] init];
        
        [lightSlider setThumbImage:PlayerImage(@"slider_thumb") forState:UIControlStateNormal];
        ...
        lightSlider.ec__centerY(_ligthCell.ec_h/2).ec_left(ligthImage1.ec_maxX).ec_width(ligthImage2.ec_minX-ligthImage1.ec_maxX);
...
- (UIView *)speedCell {
    if (!_speedCell) {
        ...
        _speedCell.ec_width(MoreViewWidth).ec_height(50).ec_left(10);
        ...
        speed.ec__centerY(_speedCell.ec_h/2);
        ...
        speed1.ec_left(speed.ec_maxX+10).ec__centerY(_speedCell.ec_h/2);
        ...
        speed2.ec_left(speed1.ec_maxX+12).ec__centerY(_speedCell.ec_h/2);
        ...
        speed3.ec_left(speed2.ec_maxX+12).ec__centerY(_speedCell.ec_h/2);
        ...
        speed4.ec_left(speed3.ec_maxX+12).ec__centerY(_speedCell.ec_h/2);
    }
    return _speedCell;
}
...
- (UIView *)mirrorCell {
    if (!_mirrorCell) {
        ...
        _mirrorCell.ec_width(MoreViewWidth).ec_height(50).ec_left(10);
        ...
        mirror.ec__centerY(_mirrorCell.ec_h/2);
        ...
        switcher.ec_right(30).ec__centerY(_mirrorCell.ec_h/2);
    }
    return _mirrorCell;
}
...
- (UIView *)hwCell {
    if (!_hwCell) {
        _hwCell = [UIView new];
        _hwCell.ec_width(MoreViewWidth).ec_height(50).ec_left(10);
