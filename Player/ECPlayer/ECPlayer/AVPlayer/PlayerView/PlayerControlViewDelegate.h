//
//  PlayerControlViewDelegate.h
//  ECPlayer
//
//  Created by chao on 2021/2/3.
//

#ifndef PlayerControlViewDelegate_h
#define PlayerControlViewDelegate_h

@class ECBasePlayerControlView;
...
/** 修改配置 */
- (void)controlViewConfigUpdate:(ECBasePlayerControlView *)controlView withReload:(BOOL)reload;
/** 重新播放 */
...
#endif /* PlayerControlViewDelegate_h */
