...
@property(nonatomic,strong) ECHaftView *leftHaft;
@property(nonatomic,strong) ECHaftView *rightHaft;
@property(nonatomic,strong) ECLineView *topLine;
@property(nonatomic,strong) ECLineView *bottomLine;
...
- (void)initSubViews:(CGRect)frame{
    ...
    _leftHaft = [[ECHaftView alloc] initWithFrame:CGRectMake(0, 0, widthHaft, height)];
    _leftHaft.alpha = 0.8;
    ...
    _rightHaft = [[ECHaftView alloc] initWithFrame:CGRectMake(width-widthHaft, 0, widthHaft, height)];
    ...
    _topLine = [[ECLineView alloc] init];
    _topLine.alpha = 0.8;
    ...
    _bottomLine = [[ECLineView alloc] init];
